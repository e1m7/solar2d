...
-- Первоначальные настройки (начало)
-- Первоначальные настройки (начало)
-- Первоначальные настройки (начало)
...
-- Первоначальные настройки (конец)
-- Первоначальные настройки (конец)
-- Первоначальные настройки (конец)


-- Функции сцены (начало)
-- Функции сцены (начало)
-- Функции сцены (начало)
...
-- 1) если жизни == 0, то надо удалить кораблик с экрана приложения
